...
st.set_page_config(page_title="Impressum & Datenschutz", page_icon="⚖️")

st.title("Impressum & Datenschutzerklärung")
st.caption("Für die Webseite: [bi-hirschaid-altendorf.streamlit.app](https://bi-hirschaid-altendorf.streamlit.app/)")
...
st.subheader("Wer wir sind")
st.write("Die Adresse unserer Website ist: [https://windpark-info.de](https://windpark-info.de). Das vollständige Impressum findest du oben.")

st.subheader("Welche personenbezogenen Daten wir sammeln und warum wir sie sammeln")
...
außerdem die IP-Adresse des Besuchers und den User-Agent-String (damit wird der Browser identifiziert), um die Erkennung von Spam zu unterstützen.

Aus deiner E-Mail-Adresse kann eine anonymisierte Zeichenfolge erstellt (auch Hash genannt) und dem Gravatar-Dienst übergeben werden, 
um zu prüfen, ob du diesen benutzt. Die Datenschutzerklärung des Gravatar-Dienstes findest du hier: [https://automattic.com/privacy/](https://automattic.com/privacy/). 
...
Anmelde-Cookies verfallen nach zwei Tagen und Cookies für die Anzeigeoptionen nach einem Jahr. Falls du bei der Anmeldung „Angemeldet bleiben“ auswählst, 
wird deine Anmeldung zwei Wochen lang aufrechterhalten. Mit der Abmeldung aus deinem Konto werden die Anmelde-Cookies gelöscht.
...
st.markdown("#### Eingebettete Inhalte von anderen Websites")
st.write("""
...
Diese Websites können Daten über dich sammeln, Cookies benutzen, zusätzliche Tracking-Dienste von Dritten einbetten und deine Interaktion 
mit diesem eingebetteten Inhalt aufzeichnen, inklusive deiner Interaktion mit dem eingebetteten Inhalt, falls du ein Konto hast und auf dieser Website angemeldet bist.
""")

st.subheader("Mit wem wir deine Daten teilen & wie lange wir sie speichern")
st.write("""
...
st.subheader("Welche Rechte du an deinen Daten hast")
st.write("""
Wenn du ein Konto auf dieser Website besitzt oder Kommentare geschrieben hast, kannst du einen Export deiner personenbezogenen Daten bei uns anfordern, 
inklusive aller Daten, die du uns mitgeteilt hast. Darüber hinaus kannst du die Löschung aller personenbezogenen Daten, die wir von dir gespeichert haben, anfordern. 
...
st.subheader("Wohin wir deine Daten senden")
st.write("Besucher-Kommentare könnten von einem automatisierten Dienst zur Spam-Erkennung untersucht werden.")
